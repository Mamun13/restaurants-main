      ...
      <nav className='navbar navbar-expand-lg navbar-dark px-4 px-lg-5 py-3 py-lg-0 '>
        ...
        <div className='collapse navbar-collapse' id='navbarCollapse'>
          <div className='navbar-nav ms-auto py-0 pe-4'>
            <Link
              href='/'
              className='nav-item nav-link active sticky_text_color'
            >
              Home
            </Link>
            <Link
              href='#Experience'
              scroll={false}
              className='nav-item nav-link sticky_text_color'
            >
              experience
            </Link>
            {/* <Link href='#Services' scroll={false} className='nav-item nav-link'>
              Service
            </Link> */}
            <Link
              href='#Discover'
            ...
            <NavDropdown
              ...
              title={
                <div className='d-flex align-items-center '>
                  <span className=' position-relative text-uppercase text-light sticky_text_color text-inter font-16 d-flex align-items-center position-relative after_border'>
                    Menu
                  </span>
